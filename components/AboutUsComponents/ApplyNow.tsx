const ApplyNow = () => {
  return (
    <section className="w-full flex flex-col space-y-6 md:space-y-0 md:flex-row py-10 px-5 md:px-24 md:space-x-5">
      <h2 className='font-bold text-center md:text-left text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl w-full md:w-3/5'>This is your chance to jumpstart your business</h2>
