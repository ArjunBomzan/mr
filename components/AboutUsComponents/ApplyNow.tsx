const ApplyNow = () => {
  return (
    <section className="w-full flex flex-col space-y-6 md:space-y-0 md:flex-row py-10  md:space-x-5  mx-auto px-5 sm:px-20 lg:px-44">
      <p className='font-bold text-center md:text-left text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl w-full md:w-3/5' style={{ lineHeight: "1.3em",  }}>This is your chance to jumpstart your business</p>
      <div className="w-full md:w-2/5 flex flex-col items-center md:items-start">
        <p className=' font-bold text-base md:text-xl  lg:text-2xl text-center md:text-left'>Interested in joining our team?</p>
