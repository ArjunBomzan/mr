...
type faqType = {
    title: string | any;
    content: string | Element | React.ReactNode | any;
};
        ...
        <>
            ...
            >
                <p
                    ref={myrefChild}
                    className={
                        faqContentStyle || "border border-t-0 border-border p-5"
                    }
                >
...
export default function Faqs({
    ...
    faqTitleStyle =
        faqTitleStyle ||
        "capitalize border border-border p-5   flex justify-between items-center transition-all duration-[.3s] rounded-xl";
