const JumpstartChild = ({ icon, title, info }) => {
  return (
    <div className='flex flex-col items-center md:w-1/2 md:w-[30%]'>
      ...
      <p className='pt-3 text-2xl font-bold text-center text-green-500'>{title}</p>
  ...
  return (
    <section className='flex flex-col px-5 py-20 md:space-y-9 h-max sm:pt-24 sm:px-10 md:px-20 lg:px-40 xl:px-48'>
      <div className='flex flex-col'>
        ...
        <p className='w-full mb-5 text-2xl font-bold text-center sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>Benifits of joining Mindrisers</p>
      ...
      <div className="flex flex-col items-center justify-between space-y-9 md:space-y-0 md:flex-row md:space-x-5 flex-nowrap py-7 ">
        ...
        <JumpstartChild
          ...
          //   </svg>
          // }
          title="Flexible Class Shedule"
          info="Our class shedules are flexible on weekdays, weekend or evenings to suit your shedule."
        />
        <JumpstartChild
          icon={
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-8 h-8 fill-green-500" fill="currentColor">
