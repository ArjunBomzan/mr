...
const Header = () => {
  ...
  return (
    <div className=' '>
      <div className='relative bg-green-500 top-0 flex flex-row justify-between items-center text-white  px-8 sm:px-12 md:px-14 lg:px-18 py-1'>
        <div className='text-md font-bold'>Contact: <span className='font-bold'>9823721737</span></div>
        <div className='flex gap-6 header-socials'>
          ...
          <Link href='https://www.instagram.com/tech.mindrisers/'>
