...
const Header = () => {
  return (
    <>
      <div id='navbar' className=' bg-green-500 top-0 flex flex-row justify-center sm:justify-between items-center text-white  px-6 sm:px-12 md:px-14 lg:px-18 py-[0.3rem]'>
