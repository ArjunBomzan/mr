...
const Header = () => {
  ...
  const commonLink = classNames(
    'gap-[30px] capitalize items-center  flex flex-col xl:flex-row ',
  )
  ...
  return (
    <>
      <div id="navbar"
        className="bg-green-50] bg-primary-light pt-[40px] overflow-visible transition  "
      >
        <div className="container">
          <div className={classNames(
            "  py-[10px] px-[40px] bg-white flex flex-wrap  xl:gap-[30px] 2xl:gap-0 xl:text-center  justify-between xl:justify-center 2xl:justify-between xl:py-[20px] 2xl:py-[10px] items-center relative z-50 shadow-small transition-all ease-linearr ",
            {
              "rounded-[0px] duration-[.3s]": menuOpen, // duration of opening 
              "rounded-[100px] duration-1000": !menuOpen
            }
          )}>
            <Link href={"/"} className="inline-flex items-center">
              <Image alt="company-logo" src={Logo} height={200} width={200} className="h-[56px] w-[56px] aspect-square" />
            ...
            <div
              ...
              className={classNames(
                "flex flex-col gap-[30px]  transition-all  ease-linearr duration-[.3s]  max-h-0 overflow-hidden w-full xl:w-auto xl:flex-row xl:max-h-[999px]",
                {
                  "!max-h-0 xl:!max-h-[999px]": !menuOpen,
                  "max-h-[988px]] mt-[30px]    ": menuOpen
