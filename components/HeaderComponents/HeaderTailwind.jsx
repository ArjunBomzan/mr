...
const HeaderTailwind = () => {
    ...
    return (
        <nav class="relative w-full flex flex-wrap items-center justify-between py-4 shadow-lg navbar navbar-expand-lg navbar-light pt-4 pb-4 px-8 sm:px-12 md:px-14 lg:px-18  duration-500 z-50">
